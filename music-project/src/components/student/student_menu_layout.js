...
import "../../js/main.js";
export default function StudentMenuLayout() {
    return (
        <div>
  <header id="header" className="header fixed-top d-flex align-items-center specialHeader">

    <div className="d-flex align-items-center justify-content-between">
      <a href="index.html" className="logo d-flex align-items-center">
        <img src="assets/img/logo.png" alt=""/>
        <span className="d-none d-lg-block">Magical Keys</span>
      </a>
      ...
      <ul className="d-flex align-items-center">
        ...
        <li className="nav-item dropdown pe-3">
          ...
          <a className="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span className="d-none d-md-block dropdown-toggle ps-2">İrem Samur</span>
          </a>
